class TestQEPestFile:
    ...
    def test_qepest_file_standard(self):
        ...
        assert qepest_output_file.output_file == "output_example.txt"
    ...
    def test_qepest_file_with_no_output_file(self):
        ...
        assert qepest_output_file.output_file == "input1.txt.out"
    ...
    def test_qepest_file_with_no_input_file(self):
        ...
        assert qepest_output_file.output_file == "data.txt.out"
